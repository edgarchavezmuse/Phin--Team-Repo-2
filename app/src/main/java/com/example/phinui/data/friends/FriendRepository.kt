            ...
            .addOnSuccessListener { fromDoc ->
                ...
                db.collection("users").document(toUid).get()
                    .addOnSuccessListener { toDoc ->
                        ...
                        // Check outgoing request (me to them)
                        db.collection("friend_requests")
                            ...
                            .addOnSuccessListener { outgoingSnapshot ->
                                ...
                                // Check incoming request (them to me)
                                db.collection("friend_requests")
                                    ...
                                    .addOnSuccessListener { incomingSnapshot ->
                                        ...
                                        if (!outgoingSnapshot.isEmpty || !incomingSnapshot.isEmpty) {
                                            onError(Exception("PENDING_REQUEST_EXISTS"))
                                            return@addOnSuccessListener
                                        }
                        ...
                        .addOnSuccessListener { outgoingSnapshot ->
                            ...
                            db.runBatch { batch ->
                                batch.update(
                                    myUserRef,
                                    "blocked",
                                    FieldValue.arrayUnion(blockedUid)
                                )
                                batch.update(
                                    myUserRef,
                                    "friends",
